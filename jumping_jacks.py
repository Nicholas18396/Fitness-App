...
# ============================================================
#
# Measures the angle at the shoulder between the hip and the
# elbow. Arms at your sides gives a small angle; arms raised
# overhead gives a large angle.
#
...
def detect_jumping_jack(landmarks):
    ...
    if smoothed_angle < ARMS_DOWN_ANGLE:
    ...
    elif smoothed_angle > ARMS_UP_ANGLE:
...
def run():
    ...
    with mp_pose.Pose(
        ...
        while cap.isOpened():
            ...
            cv2.putText(
                image,
                "Raise arms overhead to count a rep",
                (20, 320),
                cv2.FONT_HERSHEY_SIMPLEX,
                0.55,
                (200, 200, 200),
