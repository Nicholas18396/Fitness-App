...
# ============================================================
#
# The front (working) leg is whichever leg is bent the most, so
# we track the SMALLER of the two knee angles each frame rather
# than averaging them like squats does.
#
...
def detect_lunge(landmarks):
    ...
    # --------------------------------------------------------
    # CHOOSE THE MOST-BENT (FRONT) LEG
    # --------------------------------------------------------
